...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${SITE_URL}/tools/local`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
  ...
  const offerPages: MetadataRoute.Sitemap = PROMO_LANDING_PAGES.map((page) => ({
    url: `${SITE_URL}/offers/${page.slug}`,
    lastModified: new Date(page.publishedAt),
    changeFrequency: "weekly" as const,
    priority: page.variant === "bundle" ? 0.92 : 0.8,
  }));
