...
export const PROP_FIRM_PREMIUM_PITCH = `Premium (${PREMIUM_PRICE}/mo) unlocks the full ${PROP_FIRM_CHALLENGE_DAYS}-day execution plan, all ${TOOL_COUNT} planning engines, Chart Academy, and the TradeLocker bot. ${PREMIUM_PROMO_NOTE}`;

export const PROP_FIRM_PLAYBOOK_CTA = `Start the 7-Day Plan — ${PREMIUM_PROMO_CODE}`;
