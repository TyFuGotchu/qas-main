  ...
  const sections = [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        `Free accounts get one lesson, one guide, and the Setup Scorer. Premium ($149.99/mo) unlocks everything — all six planning modules, Chart Academy, TradeLocker bot, and priority email support.`,
      ],
    },
  ];
