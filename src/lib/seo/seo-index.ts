...
import { EDGE_RADAR_CLUSTER_COUNT } from "@/lib/seo/edge-radar-authority";
import {
...
export const AUTHORITY_CLUSTER_COUNT = PROP_FIRM_CLUSTER_COUNT + EDGE_RADAR_CLUSTER_COUNT;
export const AUTHORITY_PILLAR_COUNT = PILLAR_PAGES.length + 1;

export const EDGE_RADAR_SEO_PAGE_COUNT = EDGE_RADAR_CLUSTER_COUNT + 2;
