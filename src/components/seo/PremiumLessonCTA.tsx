  ...
  return (
    <GlassPanel className="relative overflow-hidden border-cyan-accent/25 bg-gradient-to-br from-slate-950 via-slate-950 to-cyan-accent/5 p-8">
      <div className="absolute right-4 top-4 opacity-20">
        <Lock className="h-16 w-16 text-cyan-accent" />
      </div>
      <Badge variant="warning" className="mb-4">
        Premium Planning Module
      </Badge>
      <div className="flex flex-wrap items-start gap-4">
        ...
        <div className="max-w-xl flex-1">
          <h3 className="font-mono text-xl font-bold text-slate-100">
            Unlock the interactive {tool.shortName} module
          </h3>
          <p className="mt-2 text-sm leading-relaxed text-slate-400">
            You have learned the theory — now score, plan, and analyze with the
            proprietary <strong className="text-slate-300">{tool.name}</strong>.
            Premium members get full access to all 6 QS Planning Modules. Manual
            trading only — no broker connection required.
          </p>
