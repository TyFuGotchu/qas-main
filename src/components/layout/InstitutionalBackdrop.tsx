    ...
    >
      ...
      {variant === "hero" && (
        <>
          ...
          <div className="qs-orb qs-orb-violet absolute bottom-0 left-1/4 h-[520px] w-[520px]" />
      ...
      {variant === "auth" && (
        <>
          ...
          <div className="qs-orb qs-orb-violet absolute bottom-0 right-0 h-[480px] w-[480px]" />
        </>
      )}
